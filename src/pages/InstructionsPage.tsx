    ...
    <div className="min-h-screen bg-dark text-white">
      ...
      <header className="sticky top-0 z-50 border-b border-white/5" style={{ background: 'rgba(10, 10, 10, 0.95)', backdropFilter: 'blur(20px)' }}>
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <h1 className="font-syncopate text-lg font-bold text-white uppercase tracking-wide">Инструкция по подключению</h1>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="glass-card p-8 lg:p-12">
          ...
          <div className="flex items-center gap-4 mb-8 pb-6 border-b border-white/10">
            ...
            <div>
              <h2 className="font-syncopate text-xl font-bold text-white uppercase tracking-wide">
          ...
          <div className="space-y-6 mb-10">
            <h3 className="font-syncopate text-lg font-bold text-white uppercase tracking-wide">
              Шаги настройки
            </h3>
          ...
          <div className="border-t border-white/10 pt-8 mb-8">
            <h3 className="font-syncopate text-lg font-bold text-white mb-4 uppercase tracking-wide">
          ...
          <div className="border-t border-white/10 pt-8">
            <h3 className="font-syncopate text-lg font-bold text-white mb-6 uppercase tracking-wide">
              Частые вопросы
            </h3>
