  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2
          ref={titleRef}
          className="font-syncopate text-3xl lg:text-4xl font-bold text-center text-white mb-12 lg:mb-16 uppercase tracking-wide"
        >
        ...
        <div ref={contentRef} className="glass-card p-8 lg:p-10">
          ...
          <div className="flex items-center gap-4 mb-8 pb-6 border-b border-white/10">
            ...
            <div>
              <h3 className="font-syncopate text-xl font-bold text-white uppercase tracking-wide">
          ...
          <div className="space-y-4 mb-10">
            <h4 className="font-syncopate text-lg font-bold text-white uppercase tracking-wide mb-4">
              Шаги настройки
            </h4>
          ...
          <div className="border-t border-white/10 pt-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h4 className="font-syncopate text-base font-bold text-white uppercase tracking-wide">
