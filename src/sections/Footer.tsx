          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto mb-16">
            {allLinks.map((link, index) => (
              <a
                ...
                className="btn-secondary flex-col items-start text-left py-5 px-5 group"
              >
                <div className="flex items-center gap-2 mb-2">
                  {link.icon === 'vk' ? (
                    ...
                    <link.icon className="w-5 h-5 text-lime" />
                  )}
                  <span className="font-montserrat font-medium text-white text-sm">
                    {link.title}
                  </span>
                </div>
                <span className="font-montserrat text-xs text-gray-light">
                  {link.description}
                </span>
              </a>
            ))}
